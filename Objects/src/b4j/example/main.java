...
b4j.example.view_ui _vu = null;
 //BA.debugLineNum = 75;BA.debugLine="Private Sub B4XTable1_CellClicked (ColumnId As Str";
 //BA.debugLineNum = 76;BA.debugLine="Log(\"Row: \"& B4XTable1.GetRow(RowId))";
anywheresoftware.b4a.keywords.Common.LogImpl("8262145","Row: "+BA.ObjectToString(_b4xtable1._getrow /*anywheresoftware.b4a.objects.collections.Map*/ (_rowid)),0);
 //BA.debugLineNum = 77;BA.debugLine="Log(\"Column: \"& B4XTable1.GetColumn(ColumnId))";
anywheresoftware.b4a.keywords.Common.LogImpl("8262146","Column: "+BA.ObjectToString(_b4xtable1._getcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (_columnid)),0);
 //BA.debugLineNum = 79;BA.debugLine="BCName = B4XTable1.GetRow(RowId).Get(\"بانک\")";
_bcname = BA.ObjectToString(_b4xtable1._getrow /*anywheresoftware.b4a.objects.collections.Map*/ (_rowid).Get((Object)("بانک")));
 //BA.debugLineNum = 80;BA.debugLine="UName = B4XTable1.GetRow(RowId).Get(\"نام خانوادگی";
_uname = BA.ObjectToString(_b4xtable1._getrow /*anywheresoftware.b4a.objects.collections.Map*/ (_rowid).Get((Object)("نام خانوادگی")));
 //BA.debugLineNum = 81;BA.debugLine="UName = UName.Replace(\" null\", \"\").Replace(\"آقا\",";
_uname = _uname.replace(" null","").replace("آقا","آقای");
 //BA.debugLineNum = 82;BA.debugLine="Gardesh = B4XTable1.GetRow(RowId).Get(\"گردش\")";
_gardesh = BA.ObjectToString(_b4xtable1._getrow /*anywheresoftware.b4a.objects.collections.Map*/ (_rowid).Get((Object)("گردش")));
 //BA.debugLineNum = 83;BA.debugLine="MelliCode = B4XTable1.GetRow(RowId).Get(\"کد ملی\")";
_mellicode = BA.ObjectToString(_b4xtable1._getrow /*anywheresoftware.b4a.objects.collections.Map*/ (_rowid).Get((Object)("کد ملی")));
 //BA.debugLineNum = 84;BA.debugLine="MablaghRil = B4XTable1.GetRow(RowId).Get(\"مبلغ\").";
...
try { //BA.debugLineNum = 86;BA.debugLine="Dim vu As view_ui";
_vu = new b4j.example.view_ui();
 //BA.debugLineNum = 87;BA.debugLine="vu.Initialize(MainForm)";
_vu._initialize /*String*/ (ba,_mainform);
 //BA.debugLineNum = 88;BA.debugLine="vu.Show";
_vu._show /*String*/ ();
 } 
       catch (Exception e14) {
			ba.setLastException(e14); //BA.debugLineNum = 91;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("8262160",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(ba)),0);
 };
 //BA.debugLineNum = 95;BA.debugLine="End Sub";
return "";
}
public static String  _fileaddress_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Private Sub fileaddress_TextChanged (Old As String";
 //BA.debugLineNum = 59;BA.debugLine="Try";
try { //BA.debugLineNum = 60;BA.debugLine="File.WriteString(File.DirApp, \"excelurl\", New)";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirApp(),"excelurl",_new);
 //BA.debugLineNum = 62;BA.debugLine="If Not(File.Exists(\"\", New)) Then";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.Exists("",_new))) { 
 //BA.debugLineNum = 63;BA.debugLine="fileaddress.Text = \"\"";
_fileaddress.setText("");
 };
 //BA.debugLineNum = 66;BA.debugLine="If New.Length>10 Then";
if (_new.length()>10) { 
 //BA.debugLineNum = 67;BA.debugLine="File.Copy(\"\", New, File.DirApp, \"excel.xlsx\")";
anywheresoftware.b4a.keywords.Common.File.Copy("",_new,anywheresoftware.b4a.keywords.Common.File.getDirApp(),"excel.xlsx");
 //BA.debugLineNum = 68;BA.debugLine="LoadSheet(0)";
_loadsheet((int) (0));
 };
 } 
       catch (Exception e11) {
			ba.setLastException(e11); //BA.debugLineNum = 71;BA.debugLine="File.WriteString(File.DirApp, \"excelurl\", \"\")";
...
String _bank = "";
String _thisgardesh = "";
 //BA.debugLineNum = 103;BA.debugLine="Private Sub LoadSheet(Index As Int)";
 //BA.debugLineNum = 105;BA.debugLine="XL.Initialize";
_xl._initialize /*String*/ (ba);
 //BA.debugLineNum = 107;BA.debugLine="Dim result As XLReaderResult = XL.Reader.ReadShee";
_result = _xl._reader /*b4j.example.xlreader*/ ._readsheetbyindex /*b4j.example.xlreaderresult*/ (anywheresoftware.b4a.keywords.Common.File.getDirApp(),"excel.xlsx",_index);
 //BA.debugLineNum = 110;BA.debugLine="result.LogResult(True)";
_result._logresult /*String*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 112;BA.debugLine="B4XTable1.HeaderFont=fx.LoadFont(File.DirAssets,";
_b4xtable1._headerfont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont(), (javafx.scene.text.Font)(_fx.LoadFont(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Ray-Black.ttf",anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15))).getObject()));
 //BA.debugLineNum = 113;BA.debugLine="B4XTable1.AddColumn(result.Get(XL.AddressName(\"B1";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (BA.ObjectToString(_result._get /*Object*/ (_xl._addressname /*b4j.example.xlutils._xladdress*/ ("B1"))),_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 114;BA.debugLine="B4XTable1.AddColumn(result.Get(XL.AddressName(\"C1";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (BA.ObjectToString(_result._get /*Object*/ (_xl._addressname /*b4j.example.xlutils._xladdress*/ ("C1"))),_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 116;BA.debugLine="B4XTable1.AddColumn(result.Get(XL.AddressName(\"AN";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (BA.ObjectToString(_result._get /*Object*/ (_xl._addressname /*b4j.example.xlutils._xladdress*/ ("AN1"))),_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 117;BA.debugLine="B4XTable1.AddColumn(result.Get(XL.AddressName(\"E1";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (BA.ObjectToString(_result._get /*Object*/ (_xl._addressname /*b4j.example.xlutils._xladdress*/ ("E1"))),_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 118;BA.debugLine="B4XTable1.AddColumn(\"مبلغ\", B4XTable1.COLUMN_TYPE";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ ("مبلغ",_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 119;BA.debugLine="B4XTable1.AddColumn(result.Get(XL.AddressName(\"Z1";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (BA.ObjectToString(_result._get /*Object*/ (_xl._addressname /*b4j.example.xlutils._xladdress*/ ("Z1"))),_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 120;BA.debugLine="B4XTable1.AddColumn(result.Get(XL.AddressName(\"AO";
_b4xtable1._addcolumn /*b4j.example.b4xtable._b4xtablecolumn*/ (BA.ObjectToString(_result._get /*Object*/ (_xl._addressname /*b4j.example.xlutils._xladdress*/ ("AO1"))),_b4xtable1._column_type_text /*int*/ );
 //BA.debugLineNum = 121;BA.debugLine="Dim TableData As List";
_tabledata = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 122;BA.debugLine="TableData.Initialize";
_tabledata.Initialize();
 //BA.debugLineNum = 123;BA.debugLine="For Row1Based = 7 To result.BottomRight.Row0Based";
{
final int step14 = 1;
...
for (;_row1based <= limit14 ;_row1based = _row1based + step14 ) {
 //BA.debugLineNum = 124;BA.debugLine="Dim City As String = result.Get(XL.AddressOne(\"B";
_city = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("B",_row1based)));
 //BA.debugLineNum = 125;BA.debugLine="Dim NameFamily As String = result.Get(XL.Address";
_namefamily = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("D",_row1based)))+" "+BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("B",_row1based)))+" "+BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("C",_row1based)));
 //BA.debugLineNum = 126;BA.debugLine="Dim Father As String = result.Get(XL.AddressOne(";
_father = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("AN",_row1based)));
 //BA.debugLineNum = 127;BA.debugLine="Dim Melli As String = result.Get(XL.AddressOne(\"";
_melli = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("E",_row1based)));
 //BA.debugLineNum = 129;BA.debugLine="Melli = Melli.Replace(\".\", \"\").Replace(\"E9\", \"\")";
_melli = _melli.replace(".","").replace("E9","");
 //BA.debugLineNum = 130;BA.debugLine="Dim Mablagh As String = result.Get(XL.AddressOne";
_mablagh = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("G",_row1based)));
 //BA.debugLineNum = 131;BA.debugLine="Dim Bank As String = result.Get(XL.AddressOne(\"Z";
_bank = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("Z",_row1based)))+" شعبه "+BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("AA",_row1based)));
 //BA.debugLineNum = 132;BA.debugLine="Dim ThisGardesh As String = result.Get(XL.Addres";
_thisgardesh = BA.ObjectToString(_result._get /*Object*/ (_xl._addressone /*b4j.example.xlutils._xladdress*/ ("AO",_row1based)));
 //BA.debugLineNum = 133;BA.debugLine="TableData.Add(Array(City, NameFamily, Father, Me";
_tabledata.Add((Object)(new Object[]{(Object)(_city),(Object)(_namefamily),(Object)(_father),(Object)(_melli),(Object)(_mablagh),(Object)(_bank),(Object)(_thisgardesh)}));
 ...
 //BA.debugLineNum = 135;BA.debugLine="B4XTable1.SetData(TableData)";
...
String _parent = "";
 ...
 //BA.debugLineNum = 41;BA.debugLine="Dim fc As FileChooser";
_fc = new anywheresoftware.b4j.objects.FileChooserWrapper();
 //BA.debugLineNum = 42;BA.debugLine="fc.Initialize";
_fc.Initialize();
 //BA.debugLineNum = 43;BA.debugLine="fc.SetExtensionFilter(\"یک فایل اکسل انتخاب کنید\",";
_fc.SetExtensionFilter("یک فایل اکسل انتخاب کنید",anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"*.xls","*.xlsx","*.csv","*.xml"}));
 //BA.debugLineNum = 45;BA.debugLine="Dim u As String";
_u = "";
 //BA.debugLineNum = 46;BA.debugLine="u = fc.ShowOpen(MainForm)";
_u = _fc.ShowOpen(_mainform);
 //BA.debugLineNum = 48;BA.debugLine="Dim name As String";
_name = "";
 //BA.debugLineNum = 49;BA.debugLine="Dim parent As String";
_parent = "";
 //BA.debugLineNum = 50;BA.debugLine="parent = File.GetFileParent(u)";
_parent = anywheresoftware.b4a.keywords.Common.File.GetFileParent(_u);
 //BA.debugLineNum = 51;BA.debugLine="name = File.GetName(u)";
_name = anywheresoftware.b4a.keywords.Common.File.GetName(_u);
 //BA.debugLineNum = 53;BA.debugLine="Log(name)";
anywheresoftware.b4a.keywords.Common.LogImpl("8131086",_name,0);
 //BA.debugLineNum = 54;BA.debugLine="Log(parent)";
anywheresoftware.b4a.keywords.Common.LogImpl("8131087",_parent,0);
 //BA.debugLineNum = 55;BA.debugLine="fileaddress.Text = parent&\"\\\"&name";
_fileaddress.setText(_parent+"\\"+_name);
 //BA.debugLineNum = 56;BA.debugLine="End Sub";
return "";
}
public static String  _sheetcombo_valuechanged(Object _value) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Private Sub SheetCombo_ValueChanged (Value As Obje";
 //BA.debugLineNum = 98;BA.debugLine="xui.MsgboxAsync(\"بارگزاری شیت \"&Value, Value)";
_xui.MsgboxAsync(ba,"بارگزاری شیت "+BA.ObjectToString(_value),BA.ObjectToString(_value));
 //BA.debugLineNum = 99;BA.debugLine="LoadSheet(Value)";
