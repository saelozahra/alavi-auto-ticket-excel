...
__c.LogImpl("941943051",("info: cannot get range of: "+__c.SmartStringFormatter("",(Object)(_namename))+" - "+__c.SmartStringFormatter("",(Object)(_formula))+" "),0);
 };
 }
};
...
parent.__c.LogImpl("942532871",_stdout,0);
 //BA.debugLineNum = 264;BA.debugLine="Log(StdErr)";
parent.__c.LogImpl("942532872",_stderr,0);
...
parent.__c.LogImpl("942598403","Cannot delete output file",0);
...
parent.__c.LogImpl("942663948",_stderr,0);
