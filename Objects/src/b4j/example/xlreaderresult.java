...
__c.LogImpl("935061761",("*** "+__c.SmartStringFormatter("",(Object)(_name))+" ***"),0);
 //BA.debugLineNum = 22;BA.debugLine="Log($\"Number of rows: ${Data.Size}\"$)";
__c.LogImpl("935061762",("Number of rows: "+__c.SmartStringFormatter("",(Object)(_data.getSize()))+""),0);
...
__c.LogImpl("935061774",("Is rectangle region: "+__c.SmartStringFormatter("",(Object)(_isrectangle))+""),0);
 //BA.debugLineNum = 35;BA.debugLine="Log($\"${xl.AddressToString(TopLeft)} -> ${xl.Add";
__c.LogImpl("935061775",(""+__c.SmartStringFormatter("",(Object)(_xl._addresstostring /*String*/ (_topleft)))+" -> "+__c.SmartStringFormatter("",(Object)(_xl._addresstostring /*String*/ (_bottomright)))+""),0);
 //BA.debugLineNum = 36;BA.debugLine="If WithContent Then";
if (_withcontent) { 
 //BA.debugLineNum = 37;BA.debugLine="Log(\"Content:\")";
__c.LogImpl("935061777","Content:",0);
...
__c.LogImpl("935061795",_sb.ToString(),0);
 }
};
 };
 };
