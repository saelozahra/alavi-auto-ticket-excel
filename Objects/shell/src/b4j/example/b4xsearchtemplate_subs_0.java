...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,128);
...
_textpane = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _tf.runClassMethod (b4j.example.b4jtextflow.class, "_createtextflow" /*RemoteObject*/ ).getObject());Debug.locals.put("TextPane", _textpane);Debug.locals.put("TextPane", _textpane);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,122);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,241);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("Initialize (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,24);
...
_sv.runMethod(false,"getInnerNode").runMethod(false,"getStyleClasses").runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("b4xdialog"))));
 BA.debugLineNum = 40;BA.debugLine="Dim jo As JavaObject = Me";
Debug.JustUpdateDeviceLine();
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref);Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 41;BA.debugLine="jo.RunMethod(\"RemoveWarning\", Null)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Resize (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,112);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("SetIndex (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,233);
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,196);
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",37,__ref.getField(false, "ba"),__ref,85);
