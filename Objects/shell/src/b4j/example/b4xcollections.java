...
public static b4j.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"CSSUtils",b4xcollections._cssutils,"DateUtils",b4xcollections._dateutils,"Main",Debug.moduleToString(b4j.example.main.class),"XUIViewsUtils",Debug.moduleToString(b4j.example.xuiviewsutils.class)};
}
}