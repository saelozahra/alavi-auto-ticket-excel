...
try {
		Debug.PushSubsStack("Base_Resize (madewithlove) ","madewithlove",42,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("DesignerCreateView (madewithlove) ","madewithlove",42,__ref.getField(false, "ba"),__ref,15);
...
Debug.JustUpdateDeviceLine();
_tf.runClassMethod (b4j.example.b4jtextflow.class, "_append" /*RemoteObject*/ ,(Object)(BA.ObjectToString(madewithlove.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xf004)))))));
...
try {
		Debug.PushSubsStack("Initialize (madewithlove) ","madewithlove",42,__ref.getField(false, "ba"),__ref,9);
