...
try {
		Debug.PushSubsStack("AddStubToCLVIfNeeded (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,34);
...
try {
		Debug.PushSubsStack("CreateB4XImageView (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,85);
...
try {
		Debug.PushSubsStack("CreateLabel (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,78);
...
try {
		Debug.PushSubsStack("Initialize (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,10);
...
try {
		Debug.PushSubsStack("PerformHapticFeedback (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,21);
...
public static RemoteObject  _setalpha(RemoteObject _view,RemoteObject _level) throws Exception{
try {
		Debug.PushSubsStack("SetAlpha (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,95);
if (RapidSub.canDelegate("setalpha")) { return b4j.example.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setalpha", _view, _level);}
...
_n = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper"), _view.getObject());Debug.locals.put("n", _n);Debug.locals.put("n", _n);
 BA.debugLineNum = 102;BA.debugLine="n.Alpha = Level";
Debug.JustUpdateDeviceLine();
_n.runMethod(true,"setAlpha",BA.numberCast(double.class, _level));
...
try {
		Debug.PushSubsStack("SetBitmapAndFill (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,65);
...
_iiv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.objects.ImageViewWrapper"), _imageview.getObject());Debug.locals.put("iiv", _iiv);Debug.locals.put("iiv", _iiv);
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (xuiviewsutils) ","xuiviewsutils",46,xuiviewsutils.ba,xuiviewsutils.mostCurrent,50);
